...
export default function Chatbot() {
  ...
  const chatPositionStyle = {
    bottom: showChat ? 'calc(100% + 1rem)' : 'initial', // Render above the button when chat is open
    top: showChat ? 'initial' : 'calc(100% + 1rem)'   // Render below when chat is closed
  };
    ...
    <div className="fixed bottom-6 right-6 z-50">
      {!showChat ? (
        ...
        <Draggable handle=".chat-header">
          <div className="absolute right-0 w-[320px] h-[480px] bg-background border border-border rounded-lg shadow-2xl flex flex-col overflow-hidden" style={chatPositionStyle}>
            {/* Header */}
